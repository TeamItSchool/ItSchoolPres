...
module MyGameInTs {
    export class GameRunningState extends Phaser.State {
        ...
        cLetterSprt: Phaser.Sprite;
        hLetterSprt: Phaser.Sprite;
        aLetterSprt: Phaser.Sprite;
        tLetterSprt: Phaser.Sprite;
        rectangleArea0: Phaser.Rectangle;
        rectangleArea1: Phaser.Rectangle;
        rectangleArea2: Phaser.Rectangle;
        rectangleArea3: Phaser.Rectangle;
        textValue: Phaser.Text;
        scoreText: Phaser.Text;
        countingScore: Phaser.Text;
        xPositionCharacterMax: number;
        yPositionCharacterMax: number;
        countScore: number;
        facing: string;
        charListRef: Array<string>;
        charListToCmp: Array<string>;
        ...
        constructor() {
            ...
            this.charListToCmp = new Array<string>();
            this.facing = "idle";
        }
        ...
        compareArray( charListRef: string[], charListCmp: string[] ) {
        ...
        update() {
            ...
            if( this.phaserSprite.position.x > this.xPositionCharacterMax ) this.phaserSprite.x = 0;
            if( this.phaserSprite.position.y > this.yPositionCharacterMax ) this.phaserSprite.y = 0;
            if( this.phaserSprite.position.x < 0 ) this.phaserSprite.x = this.xPositionCharacterMax;
            if( this.phaserSprite.position.y < 0 ) this.phaserSprite.y = this.yPositionCharacterMax;
